...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function neighborhoodChromos=creatneighborhoodChromosN7(chromo,keyBlock,schedule,keyPath)
    ...
    for i=1:blockNum
        ...
        if sizeBlock==2  % 2互换即可
            ...
            swap1=[thisBlockScheule(2,1:3),thisBlockScheule(1,4),thisBlockScheule(1,4)+(thisBlockScheule(2,5)-thisBlockScheule(2,4)),1];
            swap2=[thisBlockScheule(1,1:3),swap1(1,5),swap1(1,5)+(thisBlockScheule(1,5)-thisBlockScheule(1,4)),1];
            ...
            if blockStartJPRow %有前序工序
                ...
                if schedule(blockStartJPRow,6) %非0则是关键工序
                    % 独立的将每个块内工序移到块首之前，移动工序生成邻域解 ---内移首
