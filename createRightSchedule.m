function [standardizationChromo,schedule2]= createRightSchedule(schedule1,Cmax,workpieceNum,machNum)
    % schedule2 应该与 standardizationChromo 是一一对应关系
    %主动解码染色体标准化
    % standardizationChromo=schedule1(:,1)';
    tempscheule=sortrows(schedule1,4);
    standardizationChromo=tempscheule(:,1)';
    schedule2=nan(size(schedule1,1),5);
    [schedule1,index]=sortrows(schedule1,4);
